...
# 放到 ~/.insightface/models/buffalo_l/inswapper_128.onnx

# 下载 GFPGANv1.4.pth
# 放到 ~/ComfyUI/models/facerestore_models/GFPGANv1.4.pth
```
...
```bash
# 查看项目提交历史
cd ~/.openclaw/workspace-cortana-shadow
git log --oneline video-face-swap/
...
**维护者**: Cortana-shadow  
**最后更新**: 2026-06-06  
**项目位置**: `~/.openclaw/workspace-cortana-shadow/video-face-swap/`
